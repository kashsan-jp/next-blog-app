...
export default function Tech() {
  ...
  return (
    <div className='body'>
      ...
      <p className='text-center text-green-900 sm:text-sm lg:text-xl mb-2'>
      開発意図
      </p>
      <div className='mb-10 p-2 border border-none rounded m-auto lg:w-lg sm:w-sm bg-white'>
      ...
      <div className='p-2 border border-none rounded m-auto lg:w-lg sm:w-sm border-green-700  bg-white'>
